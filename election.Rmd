...
The Democratic National Conventoin was from July 25th to July 28th in 2016, where we see Clinton's donation types switch from
Primary to General.
...
Visualizations of the data helped me spot interesting problems in the data to fix. For instance, I needed to merge variants of the phrase "Self Employed" (like "Self-Employed" or "Self").
